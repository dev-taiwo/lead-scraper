import { setProspectQualified, downloadProspectsCsv } from '../api';

export default function ProspectsTable({ prospects, onUpdate, filters }) {
  async function toggleQualified(prospect) {
    const updated = await setProspectQualified(prospect.id, !prospect.qualified);
    onUpdate(updated);
  }
